...
- [Node.js](https://nodejs.org/en/) (I've used version `v18.20.4` while writing this doc)
...
Run `npm run test` (or `npm t` for short) to run all tests in headless mode using a desktop viewport.
...
Made with ❤️ by [Maria Eduarda Sampaio](https://www.linkedin.com/in/maria-eduarda-sampaio-955087213/).
